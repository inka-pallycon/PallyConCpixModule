...
import com.pallycon.cpix.util.PropertyUtil;
...
public class CPixCommonModule implements CpixModule {
    ...
    private final static String PALLYCON_PLAYREADY_URL
            = StringUtil.nvl(PropertyUtil.get("pallycon.playready.url"), "https://license.pallycon.com/ri/playready/licenseManager.do");
    private final static String KMS_PREFIX_URL
            = StringUtil.nvl(PropertyUtil.get("kms.prefix.url"), "https://kms.pallycon.com/cpix/pallycon/getKey/");
    private final static String KMS_PREFIX_V2_URL
            = StringUtil.nvl(PropertyUtil.get("kms.prefix.v2.url"), "https://kms.pallycon.com/v2/cpix/pallycon/getKey/");
    ...
    public CpixDTO getDashKeyInfo(String encToken) throws CpixException {
        ...
        CpixDTO requestCpixDTO = cpixBuilder
                .setWidevine()
                .setPlayReady()
...
//            m.setProperty(Marshaller.JAXB_FRAGMENT, Boolean.TRUE);
     ...
     * @throws CpixException
     */
    public CpixDTO getDashKeyInfo(String encToken, String contentId, PallyConConfig pallyConConfig) throws CpixException {
        CpixDTO responseCpixDTO;
        CpixBuilder cpixBuilder = new CpixBuilder();
        CpixDTO requestCpixDTO = cpixBuilder
                .setWidevineV2()
                .setPlayReadyV2()
                .setVideo(pallyConConfig.getVideoConfigList())
                .setAudio(pallyConConfig.getAudioConfigList())
                .setId(contentId)
                .build();
        String responseData = callMethodPostDrmKeyServer(toCpixString(requestCpixDTO), KMS_PREFIX_V2_URL + encToken);
        if(checkError(responseData)) {
            responseCpixDTO= parseCpixData(responseData);
        }else{
            throw new CpixException(responseData);
    ...
    public CpixDTO getDashKeyInfo(String encToken, String contentId, PallyConConfig pallyConConfig, Boolean keyRotation, long periodIndex) throws CpixException {
        CpixDTO responseCpixDTO;
        CpixBuilder cpixBuilder = new CpixBuilder();
        CpixDTO requestCpixDTO = cpixBuilder.setKeyRotation(keyRotation)
                .setPeriodIndex(periodIndex)
     ...
     * @throws CpixException
     */
    public CpixDTO getHlsKeyInfo(String encToken, String contentId, PallyConConfig pallyConConfig) throws CpixException {
        CpixDTO responseCpixDTO;
        CpixBuilder cpixBuilder = new CpixBuilder();
        CpixDTO requestCpixDTO = cpixBuilder
                .setFairPlayV2()
    ...
    public CpixDTO getHlsKeyInfo(String encToken, String contentId, PallyConConfig pallyConConfig, Boolean keyRotation, long periodIndex) throws CpixException {
        CpixDTO responseCpixDTO;
        CpixBuilder cpixBuilder = new CpixBuilder();
        CpixDTO requestCpixDTO = cpixBuilder.setKeyRotation(keyRotation)
                .setPeriodIndex(periodIndex)
