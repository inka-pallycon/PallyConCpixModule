...
//        byteArray[3] = (byte)(value);
  ...
  //Lpad
    ...
    /**
     *  Object -> HashMap 으로 변환
     *
     */
    public static HashMap convertObjectToMap(Object dto){
        try{
            return new ObjectMapper().convertValue(dto, HashMap.class);
        }catch(Exception e){
            e.printStackTrace();
            return null;
        }
    ...
    /**
     * List<Object Class> -> List 로 변환
     *
     */
    public static List convertObjectClsListToList(List list){

        List dataList = new ArrayList();
        for(int i=0;i<list.size();i++){
            Object obj = (Object) list.get(i);
            dataList.add(convertObjectToMap(obj));
        }
        return dataList;
    }
